...
function App() {
  ...
  /**
   * Suite au render de app, récupère les produits dans la db
   */
  useEffect(() => {
  ...
  /**
   * Appel au serveur pour récupérer les produits
   * @returns objet json
   */
  const fetchProducts = async () => {
    ...
    /**
   * Appel au serveur pour récupérer un produit à partir de l'id
   * @returns objet json
   */
